...
if __name__ == "__main__":
    ...
    epochs= 20 #100 #10
    num_printEval = 4 #2 #꼭 epochs의 약수가 되게 넣어주기. 안그럼 epochs가 조금 모자라게 돔.
    ...
    for epoch in range(int(epochs/num_printEval)):
        ...
        minLoss = train_wic_biModel(mymodel, TrainLoader, EvalLoader, bs, num_printEval, lf, optimizer, device) #3epoch마다 eval
